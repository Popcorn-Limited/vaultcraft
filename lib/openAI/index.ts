...
export async function serveToolCalls(
  ...
  try {
    const response = await axios.post(
      `https://api.openai.com/v1/threads/${runProps.threadId}/runs/${runProps.runId}/submit_tool_outputs`,
      {
        tool_outputs: [
          {
          ...
          toolCalls: [
            {
              ...
              functionName:
                res.data.required_action.submit_tool_outputs.tool_calls[0]
                  .function.name,
              arguments:
                res.data.required_action.submit_tool_outputs.tool_calls[0]
                  .function.arguments,
