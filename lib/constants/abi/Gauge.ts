export const GaugeAbi = [
  ...
  },
  {
    ...
    inputs: [{ name: "new_pending_admin", type: "address", indexed: false }],
    anonymous: false,
    type: "event",
  },
  {
    name: "NewAdmin",
    inputs: [{ name: "new_admin", type: "address", indexed: false }],
    anonymous: false,
    type: "event",
  },
  {
    ...
    inputs: [
      { name: "new_tokenless_production", type: "uint8", indexed: false },
    ],
    anonymous: false,
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { name: "delegation_proxy", type: "address" },
    ],
    outputs: [],
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: "new_pending_admin", type: "address" }],
    outputs: [],
  },
  {
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    inputs: [{ name: "new_tokenless_production", type: "uint8" }],
    outputs: [],
  },
  {
