export const OptionTokenAbi = [
  {
    inputs: [
      ...
      { internalType: "address", name: "tokenAdmin_", type: "address" },
      {
  ...
  { inputs: [], name: "OptionsToken__NotTokenAdmin", type: "error" },
  { inputs: [], name: "OptionsToken__PastDeadline", type: "error" },
  { inputs: [], name: "OptionsToken__SlippageTooHigh", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
