        ...
        case 1:
          ...
          return () =>
            handleAllowance({
              ...
              amount: postBal,
              account,
              spender: getAddress("0x036676389e48133B63a802f8635AD39E752D375D"),
              clients,
            });
        case 2:
          postBal = Number(
          ...
          console.log({
            postBal,
            ethXBal: ethX.balance,
            amount: postBal - ethX.balance,
          });
          return () =>
            mintRsEth({ amount: postBal - ethX.balance, account, clients });
        case 3:
          postBal = Number(
            await clients.publicClient.readContract({
          ...
          return () =>
            handleAllowance({
              ...
              amount: postBal,
              account,
              spender: getAddress(VAULT_ROUTER),
              clients,
            });
        case 4:
          postBal = Number(
          ...
          console.log({
            ...
            balance: vaultData.asset.balance,
            postBal,
          });
          return () =>
            vaultDepositAndStake({
