...
export const HIDDEN_VAULTS: Address[] = ["0xb6cED1C0e5d26B815c3881038B88C829f39CE949", "0x2fD2C18f79F93eF299B20B681Ab2a61f5F28A6fF",
...
export async function getVaults({ account = ADDRESS_ZERO, client, yieldOptions }: GetVaultsProps): Promise<VaultData[]> {
  ...
  const { data: allVaults } = await axios.get(`https://raw.githubusercontent.com/Popcorn-Limited/defi-db/main/archive/vaults/${chainId}.json`)
