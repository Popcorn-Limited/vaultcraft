...
export default function CardStat({ id, label, value, secondaryValue, children, tooltip, tooltipChild }: CardStatProps): JSX.Element {
  return (
    <div className="w-full md:w-1/4 cursor-pointer flex flex-row md:block justify-between md:justify-normal mt-6 md:mt-0" id={id}>
      <p
