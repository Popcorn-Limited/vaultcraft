...
export default function FundVault({
  ...
  const [selectedToken, setSelectedToken] = useState<RewardToken>(
    vaultData.rewards[0]
  );
  ...
  function handleMaxClick() {
    ...
    const stringBal = selectedToken.balance.toLocaleString("fullwide", {
      useGrouping: false,
    });
          ...
          <div className="w-full md:w-1/2 mt-4 md:mt-0 flex-grow rounded-lg border border-[#353945] bg-[#141416] p-6">
            <InputTokenWithError
              ...
              onSelectToken={(option) =>
                setSelectedToken(option as RewardToken)
              }
                ...
                <>
                  ...
                  steps.some((step) => !step.loading && step.error) ? (
                    ...
                    <MainActionButton
                      ...
                      disabled={
                        inputBalance === "0" || steps[stepCounter].loading
                      }
                    />
                  )}
                </>
