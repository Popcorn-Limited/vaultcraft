...
export default function StrategyContainer({ route, stages, activeStage }: VaultCreationContainerProps): JSX.Element {
  ...
  return (
    <VaultCreationCard activeStage={activeStage} stages={stages} >
      ...
      <div className="flex justify-end gap-3 mt-6">
        ...
        <MainActionButton label="Next" handleClick={() => router.push(`/create-vault/${route}/fees`)} disabled={!isConfigValid(adapter, adapterConfig)} />
      </div>
    </VaultCreationCard>
  )
}