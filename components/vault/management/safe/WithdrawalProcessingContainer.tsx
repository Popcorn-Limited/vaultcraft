...
import WithdrawalProcessing from "@/components/vault/management/safe/WithdrawalProcessing";
...
export default function WithdrawalProcessingContainer() {
      ...
      <section>
        {Object.keys(tokens).length > 0 &&
          vaults
            ...
            map(vault => <WithdrawalProcessing key={vault.address} vault={vault} />)
        }
      </section>
    </div>
  )
