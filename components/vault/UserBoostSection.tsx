import { formatNumber, NumberFormatter } from "@/lib/utils/formatBigNumber";
    ...
    <div className="bg-customNeutral200 p-6 rounded-lg">
      ...
      <div className="w-full md:flex md:flex-wrap md:justify-between md:gap-4">
        ...
        <CardStat
          ...
          value={`${missingVeBalance < 0 ? 0 : formatNumber(missingVeBalance)} VeVCX`}
