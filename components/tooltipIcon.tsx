...
export default function TooltipIcon({
    ...
    return (
        <div className={`flex items-center`}>
            <button type="button" onMouseOver={openModal} className={`z-[10] ${className}`}>
                <img src="/images/icons/questionCircleIconWhite.svg" alt="" />
            </button>

            <Modal show={isModalShown} setShowModal={setIsModalShown}>
                <div className="w-full h-full" onMouseLeave={closeModal}>
                    <div className={`flex flex-col gap-8 text-white pointer-events-none`}>
