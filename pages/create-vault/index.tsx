  ...
  return (
    <div className="bg-[#141416] w-full flex flex-col justify-center items-center mx-auto md:px-8 px-6 text-white">
      <div className="flex h-fit w-full max-w-[500px] rounded-[20px] border-[#23262F] border-2 p-6 flex-col justify-start md:mt-20 mt-14">
        ...
        <p className="text-[16px] mb-4 max-w-[400px]">
          Deploy an automated asset strategy in just a few clicks with
          VaultCraft!
        </p>

        <div
          className={`flex flex-col gap-3 pt-4 pb-6 border-y-[1px] border-[#353945]`}
        >
          <button
            className={`
        ...
        <a
          className={`mt-6 p-4 border-[1px] border-[#353945] flex flex-col items-stretch gap-2 rounded-[12px] bg-[url(/images/guide-bg.png)] bg-cover group`}
