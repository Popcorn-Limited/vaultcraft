...
function VePopContainer() {
  ...
  useEffect(() => {
    async function initialSetup() {
      ...
      if (_vaults.length > 0 && Object.keys(votes).length === 0 && publicClient.chain.id === SEPOLIA_CHAIN_ID) {
    ...
    <>
      ...
      <div className="static">
        ...
        <section className="my-10 px-4 md:px-8 md:flex flex-row items-center justify-between">
          <NetworkFilter supportedNetworks={[SEPOLIA_CHAIN_ID as ChainId]} selectNetwork={() => { }} />
